...
export default function Popup({
  ...
  return (
    ...
    >
      <div
        ref={popupRef}
        className="flex flex-col bg-white dark:bg-neutral-700 rounded overflow-hidden max-h-0 delay-200 duration-[1500ms]"
      >
        ...
        <div className="py-1 px-3 flex justify-end items-center border-t">
          <button
            onClick={() => closePopup()}
            className="p-1 border rounded text-sm duration-200 hover:bg-black/10 dark:hover:bg-white/10"
          >
            Close
          </button>
        </div>
