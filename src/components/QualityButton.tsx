  ...
  return (
    ...
    >
      <div className="w-full h-full flex gap-1">
        <div
          className="w-full h-full flex text-sm font-bold bg-gray-700 text-gray-50 dark:bg-zinc-300 dark:text-zinc-900 duration-500 delay-500 ease-in-out data-hq:bg-sky-700 data-hq:dark:bg-sky-700 data-hq:text-white"
        ...
        >
          ...
          <div className="z-10 w-9 h-9 rounded-full bg-white inset-ring-2 inset-ring-black/10 dark:bg-zinc-700 dark:inset-ring-white/10 origin-center scale-105"></div>
