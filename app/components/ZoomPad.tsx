...
const ZoomPad = ({ videoRef, containerRef }: { videoRef: React.MutableRefObject<HTMLVideoElement|null>, containerRef: React.MutableRefObject<HTMLDivElement|null> }) => {
    ...
    return (
        <div className="h-full flex-grow flex justify-center items-center">
            <div
                ref={zoomPadRef}
                className="flex justify-center items-center bg-gray-300 border-8 border-gray-50 rounded shadow-md dark:bg-gray-700 dark:border-gray-500 dark:text-gray-500"
